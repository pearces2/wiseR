#' Add Colors to Environment and Display
#'
#' This function adds color palettes to the environment and optionally displays them.
#' @param hex_codes A vector of hex color codes.
#' @param color_names A vector of color names.
#' @param position A numeric vector indicating the position of the color in the gradient.
#' @param colors_to_env Logical, whether to add colors to the environment.
#' @param show_colors Logical, whether to display the colors.
#' @return None.
#' @export
